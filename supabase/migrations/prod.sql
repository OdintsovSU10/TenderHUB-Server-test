...
-- Generated: 2026-01-17T23:52:07.303566
-- Database: postgres
...
CREATE TABLE IF NOT EXISTS public.cost_redistribution_results (
    ...
    CONSTRAINT cost_redistribution_results_tender_tactic_boq_key UNIQUE (boq_item_id),
    CONSTRAINT cost_redistribution_results_tender_tactic_boq_key UNIQUE (markup_tactic_id),
    CONSTRAINT cost_redistribution_results_tender_tactic_boq_key UNIQUE (tender_id)
);
...
CREATE TABLE IF NOT EXISTS public.organization_members (
    ...
    CONSTRAINT organization_members_org_fkey FOREIGN KEY (organization_id) REFERENCES public.organizations(id),
    CONSTRAINT organization_members_pkey PRIMARY KEY (id),
    CONSTRAINT organization_members_user_fkey FOREIGN KEY (user_id) REFERENCES public.users(id)
);
...
CREATE TABLE IF NOT EXISTS public.project_monthly_completion (
    ...
    CONSTRAINT project_monthly_completion_project_year_month_key UNIQUE (month),
    CONSTRAINT project_monthly_completion_project_year_month_key UNIQUE (project_id),
    CONSTRAINT project_monthly_completion_project_year_month_key UNIQUE (year)
);
...
CREATE TABLE IF NOT EXISTS public.subcontract_growth_exclusions (
    ...
    CONSTRAINT subcontract_growth_exclusions_tender_category_type_key UNIQUE (detail_cost_category_id),
    CONSTRAINT subcontract_growth_exclusions_tender_category_type_key UNIQUE (exclusion_type),
    CONSTRAINT subcontract_growth_exclusions_tender_category_type_key UNIQUE (tender_id),
...
CREATE TABLE IF NOT EXISTS public.tender_documents (
    ...
    CONSTRAINT tender_documents_tender_section_file_key UNIQUE (original_filename),
    CONSTRAINT tender_documents_tender_section_file_key UNIQUE (section_type),
    CONSTRAINT tender_documents_tender_section_file_key UNIQUE (tender_id)
);
...
CREATE TABLE IF NOT EXISTS public.tender_markup_percentage (
    ...
    CONSTRAINT tender_markup_percentage_tender_param_key UNIQUE (markup_parameter_id),
    CONSTRAINT tender_markup_percentage_tender_param_key UNIQUE (tender_id)
);
...
CREATE TABLE IF NOT EXISTS public.tender_pricing_distribution (
    ...
    CONSTRAINT tender_pricing_distribution_tender_tactic_key UNIQUE (markup_tactic_id),
    CONSTRAINT tender_pricing_distribution_tender_tactic_key UNIQUE (tender_id)
);
...
CREATE TABLE IF NOT EXISTS public.user_position_filters (
    ...
    CONSTRAINT user_position_filters_user_tender_position_key UNIQUE (position_id),
    CONSTRAINT user_position_filters_user_tender_position_key UNIQUE (tender_id),
    CONSTRAINT user_position_filters_user_tender_position_key UNIQUE (user_id)
);
...
CREATE UNIQUE INDEX cost_redistribution_results_tender_tactic_boq_key ON public.cost_redistribution_results USING btree (tender_id, markup_tactic_id, boq_item_id);
...
CREATE UNIQUE INDEX project_monthly_completion_project_year_month_key ON public.project_monthly_completion USING btree (project_id, year, month);

-- Index on public.roles
CREATE UNIQUE INDEX roles_name_key ON public.roles USING btree (name);

-- Index on public.subcontract_growth_exclusions
CREATE UNIQUE INDEX subcontract_growth_exclusions_tender_category_type_key ON public.subcontract_growth_exclusions USING btree (tender_id, detail_cost_category_id, exclusion_type);

-- Index on public.tender_documents
CREATE UNIQUE INDEX tender_documents_tender_section_file_key ON public.tender_documents USING btree (tender_id, section_type, original_filename);

-- Index on public.tender_markup_percentage
CREATE UNIQUE INDEX tender_markup_percentage_tender_param_key ON public.tender_markup_percentage USING btree (tender_id, markup_parameter_id);

-- Index on public.tender_pricing_distribution
CREATE UNIQUE INDEX tender_pricing_distribution_tender_tactic_key ON public.tender_pricing_distribution USING btree (tender_id, markup_tactic_id);
...
CREATE UNIQUE INDEX user_position_filters_user_tender_position_key ON public.user_position_filters USING btree (user_id, tender_id, position_id);
